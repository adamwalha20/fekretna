...
import { Rocket, Send, Loader2, ArrowLeft, CheckCircle2, Sparkles, AlertCircle } from 'lucide-react';
        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-800/80 shadow-2xl shadow-black/50 backdrop-blur-xl">
          {sent ? (
            <div className="text-center space-y-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-950/60 border border-cyan-500/30 text-cyan-400 mx-auto shadow-lg shadow-cyan-500/20">
