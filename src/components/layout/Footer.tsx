...
export function Footer() {
  ...
  return (
    <footer className="border-t border-slate-800/80 bg-[#050810] text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-extrabold text-lg text-white">Fekretna</span>
              <span className="text-[11px] font-semibold px-2 py-0.5 rounded-full bg-cyan-950/70 border border-cyan-500/30 text-cyan-300 font-arabic">
                من فكرة لفريق
              </span>
            </div>
            ...
            <div className="inline-flex items-center gap-1.5 text-xs text-cyan-300 bg-cyan-950/60 px-3 py-1 rounded-full border border-cyan-500/30 font-medium">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li>
                <Link href="/explore" className="hover:text-cyan-300 transition">
                  {t('navigation.exploreProjects') || 'Explorer les projets'}
                </Link>
              </li>
              <li>
                <Link href="/app/discover" className="hover:text-cyan-300 transition">
                  {t('navigation.findTeam') || 'Trouver des cofondateurs'}
                </Link>
              </li>
              <li>
                <Link href="/app/projects/new" className="hover:text-cyan-300 transition">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li>
                <Link href="/about#charte" className="hover:text-cyan-300 transition">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {cities.map((city) => (
                <span
                  key={city}
                  className="text-xs bg-[#0b1120] text-slate-300 border border-slate-800 px-2 py-0.5 rounded-lg"
                >
                  {city}
                </span>
              ))}
